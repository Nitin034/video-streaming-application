...
const refreshAccessToken = asyncHandler(async(req, res)=>{
    ...
    try {
        const decodedToken = jwt.verify(
            inComingRefreshToken,process.env.REFRES_TOKEN_SECRET
        )
...
const changeCurrentPassword = asyncHandler(async(req, res)=>{
    ...
    if(!newPassword === confPassword) {
        throw new ApiError(401, " new Password and confourm password not match")
    }
...
const getCurrentUser = asyncHandler(async(req, res)=>{
    return res
    .status(200)
    .json(200, req.user, "Current user frtch Successfully")
})
 ...
 const updateUserCoverImage = asyncHandler(async(req, res)=>{
    ...
    // const coverImageUpdated = await User.findByIdAndDelete(coverImageLocalPath)
